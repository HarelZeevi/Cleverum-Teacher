...
class EnterTest(Ui_Form):    
    def setupUi(self, Form, stackedWidgeti=None):
        ...
        self.continue_btn.clicked.connect(lambda: self.activate_client())


    def activate_client(self):
        ''' This function activates the socket client '''
        client = Client(tcp_port=8080, udp_port=8081, host='localhost', token=self.token.text(), fullname='Harel Zeevi')
    ...
    def download_test(self):
        ...
        URL = "http://localhost:8080/api/student/getTestDocument"
