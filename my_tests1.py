...
"}")
        ...
        self.stack2.addWidget(self.page_8)
...
"}")
        ...
        self.stack1.addWidget(self.page)
        self.page_2 = QtWidgets.QWidget()
        self.page_2.setObjectName("page_2")
        self.stack1.addWidget(self.page_2)
...
"}")
        ...
        self.stack3.addWidget(self.page_5)
        self.page_6 = QtWidgets.QWidget()
        self.page_6.setObjectName("page_6")
        self.stack3.addWidget(self.page_6)
...
"}")
        ...
        self.stack4.addWidget(self.page_3)
        self.page_4 = QtWidgets.QWidget()
        self.page_4.setObjectName("page_4")
        self.stack4.addWidget(self.page_4)
...
"}")
        ...
        # add test frame stack1 
        self.add_test = QtWidgets.QFrame()
        ui = AddTestCard()
        ui.setupUi(self.add_test, self.stack1)
        self.add_test.setObjectName("add_test")
        self.stack1.addWidget(self.add_test)
       
        # create test card stack1 
        self.create_test = QtWidgets.QFrame()
        ui = CreateTestCard()
        ui.setupUi(self.create_test, self.stack1)
        self.add_test.setObjectName("add_test")
        self.stack1.addWidget(self.create_test)
  
 
        # test card stack1 
        self.test = QtWidgets.QFrame()
        ui = TestCard()
        ui.setupUi(self.test, self.stack1)
        self.test.setObjectName("test")
        self.stack1.addWidget(self.test)
 

        # add test frame stack2 
        self.add_test = QtWidgets.QFrame()
        ui = AddTestCard()
        ui.setupUi(self.add_test, self.stack2)
        self.add_test.setObjectName("add_test")
        self.stack2.addWidget(self.add_test)


        # create test card stack2 
        self.create_test = QtWidgets.QFrame()
        ui = CreateTestCard()
        ui.setupUi(self.create_test, self.stack2)
        self.add_test.setObjectName("add_test")
        self.stack2.addWidget(self.create_test)
 

        # add test frame stack3
        self.add_test = QtWidgets.QFrame()
        ui = AddTestCard()
        ui.setupUi(self.add_test, self.stack3)
        self.add_test.setObjectName("add_test")
        self.stack3.addWidget(self.add_test)


        # create test card stack3 
        self.create_test = QtWidgets.QFrame()
        ui = CreateTestCard()
        ui.setupUi(self.create_test, self.stack3)
        self.add_test.setObjectName("add_test")
        self.stack3.addWidget(self.create_test)
 

        # add test frame stack4 
        self.add_test = QtWidgets.QFrame()
        ui = AddTestCard()
        ui.setupUi(self.add_test, self.stack4)
        self.add_test.setObjectName("add_test")
        self.stack4.addWidget(self.add_test)


        # create test card stack4 
        self.create_test = QtWidgets.QFrame()
        ui = CreateTestCard()
        ui.setupUi(self.create_test, self.stack4)
        self.add_test.setObjectName("add_test")
        self.stack4.addWidget(self.create_test)
